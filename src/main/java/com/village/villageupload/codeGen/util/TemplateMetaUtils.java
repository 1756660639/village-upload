package com.village.villageupload.codeGen.util;
...
public final class TemplateMetaUtils {
     ...
     * 生成元数据的模板内容
     */
    public static String generateMetaContent(GenTemplateConfigEntity template) {
     ...
     * 解析元数据信息
     */
    public static String generateMetaRow(GenTemplateConfigEntity template) {
