<template>
  <div>
    <el-table :header-cell-style="{background:'#f5f6f6'}" :data="formData" border style="width: 100%">
      ...
      <el-table-column prop="readOnly" label="只读" width="80">
        <template slot="header" slot-scope="scope">
          <el-checkbox v-model="checkAll" :indeterminate="isIndeterminate" @change="handleCheckAllChange">只读</el-checkbox>
        </template>
        <template slot-scope="scope">
      ...
      <el-table-column prop="editable" label="可编辑" width="90">
        <template slot="header" slot-scope="scope">
          <el-checkbox v-model="checkAll" :indeterminate="isIndeterminate" @change="handleCheckAllChange">可编辑</el-checkbox>
        </template>
        <template slot-scope="scope">
